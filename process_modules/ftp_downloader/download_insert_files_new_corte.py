                ...
                for file_db in file_list_to_read_insert_bd:
                    ...
                    try:
                        ...
                        if tipo_file == "Aviso_equipo_normal":
                            ...
                            path_base_ftp_fe_salida=f"{properties.path_base_ftp}{properties.path_salida_fe_local}/{periodo}/CORTE{id_corte}_CICLO{ciclo}/"
                            path_base_local_fe_salida=f"{properties.path_base_local}/SALIDA/FE/{periodo}/CORTE{id_corte}_CICLO{ciclo}/"
                            path_base_ftp_fep_salida=f"{properties.path_base_ftp}{properties.path_ftp_insumos_local}/{periodo}/CORTE{id_corte}_CICLO{ciclo}/"
